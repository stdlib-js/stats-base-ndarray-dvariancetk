...
var s=require('@stdlib/ndarray-base-numel-dimension/dist'),q=require('@stdlib/ndarray-base-stride/dist'),o=require('@stdlib/ndarray-base-offset/dist'),c=require('@stdlib/ndarray-base-data-buffer/dist'),d=require('@stdlib/ndarray-base-ndarraylike2scalar/dist'),m=require('@stdlib/stats-strided-dvariancetk/dist').ndarray;function f(i){var r,e;return e=i[0],r=d(i[1]),m(s(e,0),r,c(e),q(e,0),o(e))}t.exports=f
});var l=require("path").join,g=require('@stdlib/utils-try-require/dist'),j=require('@stdlib/assert-is-error/dist'),k=v(),a,n=g(l(__dirname,"./native.js"));j(n)?a=k:a=n;module.exports=a;
/** @license Apache-2.0 */
